...
export default function RedePage() {
  ...
  // CORREÇÃO: Adicionando o protocolo https:// e garantindo que o link seja completo
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <h1 className="text-3xl font-black text-white italic tracking-tighter uppercase leading-none">Minha <span className="text-[#C9A66B]">Rede</span></h1>
          <p className="text-slate-500 text-sm mt-1">Gerencie sua equipe e amplie seus ganhos.</p>
        </div>

        {/* Link estilo apenas borda com protocolo correto */}
        <div className="flex items-center gap-2 p-1 rounded-xl border border-[#C9A66B]/30 bg-black/40">
          <div className="px-4 py-2">
            ...
            {/* O link agora é exibido com https:// para garantir a ação de clique */}
      ...
      {/* CARDS DE ESTATÍSTICAS (MANTIDOS CONFORME LAYOUT APROVADO) */}
